...
<div class="titlebar">
    ...
    <div class="buttonWrapper">
        ...
        var myWindow;
        function openWin() {
            myWindow = window.open('registration_popup.html', 'myWindow', 'top=100,left=300,width=500,height=800');
...
<div class="searchbox">
    <form id="studentInfo">
        <div class="searchbox_txtwrapper">
            ...
            <input type="text" class="text" name="a"></p>
            <p class="searchbox_txt3">学科コース</p>
